...
//		operationLogService.addOperationLogThead(user,"角色管理","删除角色："+olsRole.getRoleName(),Constants.OPERA_TYPE_ROLE);
	...
	/**
	 * 功能描述: 根据类型和角色名来查找对应的角色ID
	 * 创建者: zhangwei
	 * 创建时间: 2017/12/28 10:58
	 * @param roleName 角色名称
	 * @param type 角色类型
	 * @return 匹配的角色ID
	 */
	public Integer getByRoleName(String roleName,Integer type){
		return get(TRole.class,new String[]{"roleName","type"},new Object[]{roleName,type}).getRoleId();
	}
}
