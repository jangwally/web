...
<form id="pagerForm" method="post" action="orginfo/list?orgType=${bean.orgType}">
    ...
    <input type="hidden" name="parentOrgName" value="${parentOrgName}"/>
    <input type="hidden" name="parentOrgValue" value="${parentOrgValue}"/>
...
<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
            ...
            <li><a class="add"
                   onclick="add('orginfo/toAdd?orgInfoNum=${bean.orgInfoNum}&orgType=2','添加会员',450,300,'main_')"><span>添加</span></a>
            </li>
        ...
        <tr>
            ...
            <td>
                ...
                <a class="btn btn-success btn-sm"
                   onclick="add('orginfo/toUpdateOrgName?orgInfoNum=${item.orgInfoNum}&orgType=${item.orgType}','修改用户信息',450,300,'main_')">修改名称</a>
