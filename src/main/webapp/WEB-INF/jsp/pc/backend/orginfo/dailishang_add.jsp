    ...
    <form method="post" action="orginfo/add" id="forms" class="pageForm required-validate"
        ...
        <div class="pageFormContent nowrap" layoutH="63">
            <p style="float: none;">
                ...
                <a class="btnLook" href="orginfo/findOrgBack?orgType=3" style="text-decoration:none" lookupGroup="org1"
            ...
            <p style="float: none;">
                <label>登录密码：</label>
                <input name="loginPass" style="width: 180px;" class="required" id="loginPass" type="text" size="30"
                       id="loginPass"/>
            </p>
